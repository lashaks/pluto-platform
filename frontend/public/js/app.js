...
function showCredentials(login,password,server){const m=document.createElement('div');m.className='modal-bg';m.id='credModal';m.innerHTML=`<div class="modal" style="max-width:420px"><button class="modal-close" onclick="document.getElementById('credModal').remove()">&times;</button><h2>Trading Credentials</h2><p style="color:var(--t2);font-size:.84rem;margin-bottom:16px">Use these to log into cTrader</p><div style="display:flex;flex-direction:column;gap:10px"><div style="display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:var(--bg);border:1px solid var(--brd);border-radius:var(--r)"><div><div style="font-size:.68rem;color:var(--t3);text-transform:uppercase;letter-spacing:.08em;font-weight:700">Login</div><div style="font-size:1.1rem;font-family:var(--fm);font-weight:700;color:var(--ac2);margin-top:2px">${login}</div></div><button class="btn btn-outline btn-sm" onclick="navigator.clipboard.writeText('${login}');toast('Login copied','success')">Copy</button></div><div style="display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:var(--bg);border:1px solid var(--brd);border-radius:var(--r)"><div><div style="font-size:.68rem;color:var(--t3);text-transform:uppercase;letter-spacing:.08em;font-weight:700">Password</div><div style="font-size:1.1rem;font-family:var(--fm);font-weight:700;color:var(--t1);margin-top:2px">${password}</div></div><button class="btn btn-outline btn-sm" onclick="navigator.clipboard.writeText('${password}');toast('Password copied','success')">Copy</button></div><div style="display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:var(--bg);border:1px solid var(--brd);border-radius:var(--r)"><div><div style="font-size:.68rem;color:var(--t3);text-transform:uppercase;letter-spacing:.08em;font-weight:700">Server</div><div style="font-size:1.1rem;font-family:var(--fm);color:var(--t1);margin-top:2px">${server}</div></div><button class="btn btn-outline btn-sm" onclick="navigator.clipboard.writeText('${server}');toast('Server copied','success')">Copy</button></div></div></div>`;document.body.appendChild(m)}
